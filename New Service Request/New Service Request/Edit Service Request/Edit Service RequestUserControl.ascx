...
<%@ Register TagPrefix="WebPartPages" Namespace="Microsoft.SharePoint.WebPartPages"
    Assembly="Microsoft.SharePoint, Version=14.0.0.0, Culture=neutral, PublicKeyToken=71e9bce111e9429c" %>
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Edit Service RequestUserControl.ascx.cs"
    Inherits="New_Service_Request.Edit_Service_Request.Edit_Service_RequestUserControl" %>
<div>
    <table>
        <tr>
        ...
        <tr>
            ...
            <td style="width: 200px; height: 40px" valign="middle">
                <asp:TextBox ID="txtIssueRisk" runat="server" Width="320px"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td style="width: 200px; height: 40px" valign="middle">
